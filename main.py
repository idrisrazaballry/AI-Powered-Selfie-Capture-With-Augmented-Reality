...
# --------------------------------------------------------------------------
#  FIX: Robust Filter Imports (Fire Eyes block is REMOVED)
# --------------------------------------------------------------------------
...
# The import block for fire_eyes is removed.
...
def run():
    ...
    # --------------------------------------------------------------------------
    #  FIX: Robust Camera Initialization (Fixes cv2.NET_DSHOW error)
    # --------------------------------------------------------------------------
    try:
        # Use CAP_DSHOW, which is the standard constant, and wrap it in a try block.
        cap=cv2.VideoCapture(0,cv2.CAP_DSHOW) 
    except AttributeError:
        # Fallback if CAP_DSHOW is missing or not recognized
    ...
    if not cap.isOpened():
        ...
        return # Exit the function if camera can't open
    ...
    # --------------------------------------------------------------------------
    #  FIX: Removed "Fire Eyes" button here (Removed the apply_fire_eyes tuple)
    # --------------------------------------------------------------------------
    ...
    def set_mode(m):
        ...
        print("\nMode:",m) # Added newline for clarity
